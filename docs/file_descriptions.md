cli.py
The command-line entrypoint for the whole project. This is the file that turns terminal commands like python -m gsd ... or gsd run-textbook ... into calls to the right pipeline functions.
